			...
			if (!(dwProto == null) && !(dwProto.getVPorts() == null)
				...
				try {
					...
					for (int j = 0; j < infos.length; j++) {
						...
						res += "device|" + j + "|" + dev.getClass().getSimpleName() + "|" + i.getName() + "|"
								+ i.getDescription() + "|" + i.getVendor() + "|" + i.getVersion() + "\r\n";

					}

					@SuppressWarnings("unchecked")
					List<HierarchicalConfiguration> profiles = DriveWireServer.getConfig()
